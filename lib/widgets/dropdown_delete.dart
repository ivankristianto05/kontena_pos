...
class DropdownDelete extends StatefulWidget {
  const DropdownDelete({super.key});

  @override
  _DropdownDeleteState createState() => _DropdownDeleteState();
}

class _DropdownDeleteState extends State<DropdownDelete> {
  String? pickupType;
  String? table;
