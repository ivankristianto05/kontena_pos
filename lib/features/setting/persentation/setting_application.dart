...
class _SettingApplicationState extends State<SettingApplication> {
  ...
  void initState() {
    ...
    setState((){
      ...
      if ((AppState().configApplication != null) && (AppState().configApplication.containsKey('itemGroupSelectedPrint'))) {
        selectedItemGroup = AppState().configApplication['itemGroupSelectedPrint'];
      }
    });
  }
                                                        ...
                                                        CustomElevatedButton(
                                                          ...
                                                          buttonStyle:
                                                              CustomButtonStyles
                                                                  .primaryButton,
                                                          onPressed: () {
                                                            onTapSaveConfiguration(context);
                                                          },
                                                        ),
                                                      ],
                                                    ),
